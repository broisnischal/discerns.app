import { Check, File, FileImage, FileText, Loader2, Upload, X } from "lucide-react";
...
function FileUploadDropzone({
  ...
  return (
    <label
      ...
      className={cn(
        "relative flex min-h-[32px] min-w-[32px] cursor-pointer flex-col items-center justify-center gap-4 rounded-lg border-2 border-dashed p-8 transition-colors focus-within:ring-2 focus-within:ring-ring focus-within:ring-offset-2 focus-within:outline-none",
        isDragging
...
function FileUploadItem({
  ...
  return (
    <div className="flex flex-col gap-2 rounded-lg border bg-card p-3" role="listitem">
      <div className="flex items-center gap-3">
        {showPreview && uploadedFile.preview && uploadedFile.file.type.startsWith("image/") ? (
          <img
          ...
          <div className="flex size-12 shrink-0 items-center justify-center rounded-md bg-muted">
            {uploadedFile.file.type.startsWith("image/") ? (
              <FileImage aria-hidden="true" className="size-6 text-muted-foreground" />
        ...
        <div className="flex min-w-0 flex-1 flex-col gap-2">
          <div className="flex items-center justify-between gap-2">
            <div className="flex min-w-0 flex-1 flex-col gap-2">
              <p className="text-sm font-medium wrap-break-word">{uploadedFile.file.name}</p>
            ...
            <div className="flex shrink-0 items-center gap-2">
              ...
              {isCompleted && (
                <Check aria-label="Upload completed" className="size-4 text-green-600" />
              )}
              {isError && <X aria-label="Upload error" className="size-4 text-destructive" />}
              {onRemove && (
                <Button
    ...
    <Card className={cn("w-full shadow-xs", className)}>
      <CardHeader>
        <div className="flex flex-col gap-2">
          ...
          <CardDescription>Upload images, documents, or code files for AI analysis</CardDescription>
        </div>
      </CardHeader>
      <CardContent className="-mt-4">
        <div className="flex flex-col gap-4">
          ...
          {errors._general && (
            <FileUploadError message={errors._general} onDismiss={handleDismissError} />
          )}
