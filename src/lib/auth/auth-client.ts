...
export const authClient = createAuthClient({
  // Always use current origin in the browser to avoid cross-origin auth calls
  // when env injection is stale/missing in a deployment.
  baseURL: typeof window !== "undefined" ? window.location.origin : env.VITE_BASE_URL,
});
